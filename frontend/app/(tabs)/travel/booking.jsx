        ...
        >
            ...
            <View className="flex-row items-center justify-between mb-6">
                <View className="flex-row items-center flex-1">
                    ...
                    <Text className="ml-3 font-semibold text-white text-lg flex-1" numberOfLines={1}>
            ...
            <View className="space-y-4">
                ...
                <View className="flex-row items-center">
                    ...
                    <View className="flex-1">
                        <Text className="text-gray-200 font-medium text-base" numberOfLines={2}>
                            {leg.from.name}
                        </Text>
                    </View>
                </View>
            ...
            >
                ...
                <View className="px-4 pb-4">
                    <View className="bg-[#131d2a] rounded-2xl p-5 shadow-lg border border-[#1e2b3a]">
                        <Text className="text-gray-400 text-sm font-medium">Total Amount</Text>
                        <View className="flex-row items-center mt-1">
                            <Text className="text-3xl font-bold text-white">₹{bookingAmount}</Text>
